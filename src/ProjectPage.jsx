        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          <div className="lg:col-span-4 space-y-12 text-left">
            <section>
              ...
              <p className="text-lg leading-relaxed text-zinc-400 font-light italic">{description}</p>
            </section>
            <div className="pt-8 border-t border-zinc-900 text-left">
              <h3 className="text-[10px] tracking-[0.3em] uppercase text-zinc-500 mb-6 font-bold uppercase">Access Repository</h3>
              <div className="flex flex-col gap-4">
                <a href={githubLink} target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-4 bg-zinc-900/50 border border-zinc-800 hover:border-sky-500/50 hover:bg-zinc-900 transition-all group">
                  <span className="text-sm font-mono tracking-widest text-zinc-400 group-hover:text-white uppercase">Git_Source</span>
                  <Github size={18} />
                </a>
                {liveLink && (
                  <a href={liveLink} target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-4 bg-sky-500/5 border border-sky-500/20 hover:border-sky-500 hover:bg-sky-500/10 transition-all group">
